...
public class NetDrawClient extends JComponent {
    ...
    public NetDrawClient(String title, int width, int height, int graphicsWidth, int graphicsHeight) {
       ...
       //lineStyle.addItem(new ComboBoxItem(ImageStore.getImage(1), "Line"));
        ...
        lineStyle.addItem(new ComboBoxItem(ImageStore.getImage(2), "Carré"));
        lineStyle.addItem(new ComboBoxItem(ImageStore.getImage(4), "Triangle"));
        lineStyle.addItem(new ComboBoxItem(ImageStore.getImage(5), "Étoile"));
        ...
        menuItem1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Impossible de se connecter � " + serverHostname + " sur le port 1515", "Probleme de connection", JOptionPane.ERROR_MESSAGE); 
                }
            }
        });
